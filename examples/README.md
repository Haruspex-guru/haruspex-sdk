...
| - | --------- | ------------ | ----- |
| 1 | [`01-score-a-stock-js`](./01-score-a-stock-js/) | CLI: print one ticker's score and top 3 dimensions | Node, `@haruspex/sdk` |
| 2 | [`02-score-a-stock-py`](./02-score-a-stock-py/) | Same, in Python | Python, `haruspex-sdk` |
| 3 | [`03-portfolio-watchlist-js`](./03-portfolio-watchlist-js/) | Read tickers from JSON, batch, print sorted table | Node, `@haruspex/sdk` |
| 4 | [`04-discord-bot-js`](./04-discord-bot-js/) | `!score TSLA` Discord bot | Node, `discord.js`, `@haruspex/sdk` |
